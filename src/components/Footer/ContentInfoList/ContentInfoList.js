...
function ContentInfoList() {
  ...
  function showItem(items) {
    return items.map((item, index) => {
      return (
        <li className="content-info_item">
          <div className="content-info_item-header">{item.header}</div>
          <div className="content-info_item-description">{item.description}</div>
        </li>
      )
    })
  }
  ...
  return (
    <ul className="content-info_list">
      {showItem(items)}
    </ul>
  );
}
